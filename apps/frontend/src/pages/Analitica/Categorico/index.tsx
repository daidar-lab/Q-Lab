...
import { CategoricoChart } from '../../../components/charts/CategoricoChart';
import type { ContextoAnalise } from '@qlab/types';

export default function CategoricoPage() {
    ...
    return (
        <div style={{ padding: '16px', maxWidth: '600px', margin: '0 auto', fontFamily: 'sans-serif' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
                <div>
                    <h2 style={{ margin: 0, fontSize: '20px', fontWeight: 700, color: '#18181b' }}>Ensaio Categórico</h2>
            ...
            {!carregando && !erro && dados && <CategoricoChart dados={dados} />}
        </div>
    );
}
